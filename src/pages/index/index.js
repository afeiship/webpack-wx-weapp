...
nx.Page({
  data: {
    ...
    auth: {},
    mini: false,
    richWxml: `<p>订阅号是<tu-anchor rel="noreferrer noopener" href="#">微信公众平台</tu-anchor>的<span style="font-family:SimSun, STSong" class="tss-font-family">一种帐号类型</span>，旨在为用户提供信息。功能如下：</p>`,
